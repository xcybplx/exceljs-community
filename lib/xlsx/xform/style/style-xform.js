...
// <xf numFmtId="[numFmtId]" fontId="[fontId]" fillId="[fillId]" borderId="[xf.borderId]" xfId="[xfId]" quotePrefix="1">
//   Optional <alignment>
//   Optional <protection>
// </xf>
  ...
  parseOpen(node) {
    ...
    switch (node.name) {
      case 'xf':
        ...
        if (node.attributes.quotePrefix === '1' || node.attributes.quotePrefix === 'true') {
