const fs = require('fs');
// archiver 8 is ESM-only and replaced the callable archiver('zip', options)
// factory with one exported class per format. Reaching it from CommonJS relies
// on require(esm), which is why engines.node starts at 22.12.
